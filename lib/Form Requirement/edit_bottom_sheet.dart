...
class MyFormEditBottomSheet extends StatefulWidget {
  final void Function(ManagerRequiredModel) onComplete;
  final VoidCallback onExit;
  final ManagerRequiredModel item;
  const MyFormEditBottomSheet(
      {super.key,
  ...
  @override
  State<MyFormEditBottomSheet> createState() => _MyFormEditBottomSheetState();
}

class _MyFormEditBottomSheetState extends State<MyFormEditBottomSheet> {
  Color themeColor = const Color.fromARGB(215, 24, 167, 176);
  late List<MemberInWriting> newListMembers = [];
  ...
  void initState() {
    ...
    newListMembers = List<MemberInWriting>.from(widget.item.members);
  }
                      ...
                      return index == newListMembers.length
                          ? Container(
                              ...
                              child: IconButton(
                                ...
                                onPressed: () {
                                  setState(() {
                                    newListMembers.add(MemberInWriting(id: ""));
                                  });
                                },
                              ),
                            )
